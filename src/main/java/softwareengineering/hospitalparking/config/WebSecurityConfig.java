package softwareengineering.hospitalparking.config;
...
import softwareengineering.hospitalparking.service.UserDetailService;
    ...
    public SecurityFilterChain fileterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .formLogin() // 폼 기반 로그인 설정
                    ...
                    .defaultSuccessUrl("/", true) // 로그인이 완료되었을 때 이동할 경로
                .and()
                .logout() // 로그아웃 설정
